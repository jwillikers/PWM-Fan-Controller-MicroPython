...
image:https://github.com/jwillikers/PWM-Fan-Controller-MicroPython/actions/workflows/ci.yml/badge.svg["CI", link="https://github.com/jwillikers/PWM-Fan-Controller-MicroPython/actions/workflows/ci.yml"]
