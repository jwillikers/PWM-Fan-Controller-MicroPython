...
image:https://github.com/jwillikers/pwm-fan-controller-micropython/actions/workflows/ci.yml/badge.svg?branch=main["CI", link="https://github.com/jwillikers/pwm-fan-controller-micropython/actions/workflows/ci.yml"]
